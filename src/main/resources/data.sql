...
--  Create Cars.
insert into car (carid, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer, deleted) 
values (1, now(), 'BENZ-123', 5, 'NO', 5, 'GAS', 'BENZ', false );

insert into car (carid, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer, deleted) 
values (2, now(), 'VOLVO-145', 7, 'YES', 3, 'ELECTRONIC', 'VOLVO', false );

insert into car (carid, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer, deleted) 
values (3, now(), 'TATA-NEXON', 5, 'NO', 1, 'SOLAR', 'TATA', false );

insert into car (carid, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer, deleted) 
values (4, now(), 'TOYOTO-176', 2, 'YES', 4, 'GAS', 'TOYOTO', false );